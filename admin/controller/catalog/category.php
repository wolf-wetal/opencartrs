...
class Category extends \Opencart\System\Engine\Controller {
	...
	public function form(): void {
        ...
        if (!empty($category_info)) {
            $data['icon_category'] = $category_info['icon_category'];
        } else {
            $data['icon_category'] = '';
        }
        ...
        if (is_file(DIR_IMAGE . html_entity_decode($data['icon_category'], ENT_QUOTES, 'UTF-8'))) {
            $data['thumb_icon_category'] = $this->model_tool_image->resize(html_entity_decode($data['icon_category'], ENT_QUOTES, 'UTF-8'), 100, 100);
        } else {
            $data['icon_category'] = $data['placeholder'];
        }
