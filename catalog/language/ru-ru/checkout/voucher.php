...
// Help
$_['help_message']     = 'Сообщение или поздравление для получателя сертификата (не обязательно)';
$_['help_amount']      = 'Должна быть больше %s и меньше %s';

// Error
$_['error_token']      = 'Внимание: токен подарочного сертификата недействителен!';
