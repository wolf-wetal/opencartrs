...
$_['text_agree']           = 'Я прочитал <a href="%s" class="modal-link"><b>%s</b></a> и согласен с <br /> условиями безопасности и обработки персональных данных';
...
// Error
$_['error_token']          = 'Предупреждение: Регистрационный токен недействителен!';
$_['error_exists']         = 'Данный E-Mail уже зарегистрирован!';
$_['error_customer_group'] = 'Группа клиентов не действительна!';
