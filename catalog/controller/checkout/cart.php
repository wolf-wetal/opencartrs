...
class Cart extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('checkout/cart', 'language=' . $this->config->get('config_language')) . '.html'
		];
...
//        die();
	...
	public function getList(): string {
		$data['list'] = $this->url->link(' ', 'language=' . $this->config->get('config_language')) . '.html';
		//$data['product_edit'] = $this->url->link('checkout/cart.edit', 'language=' . $this->config->get('config_language'));
        $data['product_edit_plus'] = $this->url->link('checkout/cart.edit_plus', 'language=' . $this->config->get('config_language'));
        $data['product_edit_minus'] = $this->url->link('checkout/cart.edit_minus', 'language=' . $this->config->get('config_language'));
        ...
        $data['totals_summ'] = $this->currency->format($total, $this->session->data['currency']);
	...
	public function add(): void {
		...
		if (!$json) {
			...
			$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product', 'language=' . $this->config->get('config_language') . '&product_id=' . $product_id) . '.html', $product_info['name'], $this->url->link('checkout/cart', 'language=' . $this->config->get('config_language')));
			...
			$json['redirect'] = $this->url->link('product/product', 'language=' . $this->config->get('config_language') . '&product_id=' . $product_id, true) . '.html';
		}
     ...
     * @return void
     */
    public function edit_plus(): void {
        $this->load->language('checkout/cart');
     ...
     * @return void
     */
    public function edit_minus(): void {
        $this->load->language('checkout/cart');
	...
	public function remove(): void {
		...
		if (!$json) {
			...
			if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
				...
				$json['redirect'] = $this->url->link('checkout/cart', 'language=' . $this->config->get('config_language'), true) . '.html';
			}
