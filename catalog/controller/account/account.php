...
class Account extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		if (!$this->customer->isLogged() || (!isset($this->request->get['customer_token']) || !isset($this->session->data['customer_token']) || ($this->request->get['customer_token'] != $this->session->data['customer_token']))) {
            ...
            $this->session->data['redirect'] = $this->url->addHtmlSuffixToUrls($this->url->link('account/account', 'language=' . $this->config->get('config_language')));
/*            var_dump($this->url->addHtmlSuffixToUrls($this->url->link('account/login', 'language=' . $this->config->get('config_language'))));
            die();*/

			$this->response->redirect($this->url->addHtmlSuffixToUrls($this->url->link('account/login', 'language=' . $this->config->get('config_language'))));
		}
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->addHtmlSuffixToUrls($this->url->link('account/account', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token']))
		];
